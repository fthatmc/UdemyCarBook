...
using UdemyCarBook.Application.Features.Mediator.Results.CarDescriptionResult;
...
{
	internal class GetCarDescriptionByCarIdQueryHandler : IRequestHandler<GetCarDescriptionByCarIdQuery, GetCarDescriptionQueryResult>
	{
