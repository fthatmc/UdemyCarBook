...
//1. ADIM SÝGNALR Cors Politikasý baðlantý için
...
app.UseCors("CorsPolicy"); //2. adým signalR
...
app.MapControllers();
app.MapHub<CarHub>("/carhub"); //3.ADIM signalR tarafýnda istek yapabilmemizi saðlaycak 
